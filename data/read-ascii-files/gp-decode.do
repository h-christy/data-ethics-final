*-------------------------------------------------------------
* Stata .do file for sample1 (general public)
*-------------------------------------------------------------
...
local datafile "../ICPSR_07202/DS0001/07202-0001-Data.txt"   // Download the data folder from ICPSR_07202 and replace with your file path
local dictfile "../sample1.dct"  // .dct file is provided so just change the path

* Import data
infile using "`dictfile'", using("`datafile'") clear

label data "Communism, Conformity, and Civil Liberties Study, 1954"
...
label define v27    1 "EDUCATORS AND INTELLECTUALS" 2 "MEN IN GOVERNMENT, PUBLIC LIFE, PUBLIC EYE" 3 "LABORING CLASSES, OTHER ORDINARY PEOPLE" 4 "LIBERALS (NOT COMMUNISTS)" 5 "COMMUNISTS, TRAITORS, ETC." 6 "SPECIAL MINORITIES, LIKE FOREIGN BORN, NEGROES, ETC." 8 "ALL OTHERS, DON'T KNOW, VAGUE, IRRELEVANT" 9 "NA, NO ANSWER OR NOT ASKED, NO ADDITIONAL MENTION" 0 "INAP. (1 OR 8 TO REF.NO.26)" ;
...
label define v150    1 "THIS PERSON LIVES IN ONE OF THE COUNTRIES OF THE" 5 "IF PERSON DOES NOT LIVE IN A COUNTY TO WHICH THE LEADERSHIP BALLOT WAS SENT" 9 "NA" ;

label define v151    1 "CITY OF OVER 100,000 OR SUBURBS" 2 "CITY OF 2,500 UP TO 100,000" 3 "TOWN UNDER 2,500 OR COUNTRY (NON-FARM)" 4 "FARM" ;

label define v152    1 "MAY" 2 "JUNE 1 TO 15" 3 "JUNE 16 TO 30" 4 "JULY" 9 "NO DATE" ;

#delimit cr

save "stouffer-public.dta", replace
